...
categoryTypeMap.set("Volume Introduced", "Scalar");
categoryTypeMap.set("Gender", "Binary");
categoryTypeMap.set("Species", "Binary");
    ...
    function GuessDetail({guess, type, response, content}: {guess: string, type: string, response: string, content: string}) {
      ...
      switch (type) {
        ...
        case "Scalar":
          ...
          switch (response) {
            case "High":
              scalarStyling = "bg-red-500 up-arrow-clip-path"
              break;
            case "Low":
              scalarStyling = "bg-red-500 down-arrow-clip-path"
              break;
            case "Correct":
              scalarStyling = "bg-green-500"
              break;
          }
